...
#define BMP_COPYRIGHT_SECTION_SIZE 256
#define BMP_1BPP_DATA_OFFSET (BMP_HEADER_SIZE + BMP_INFO_HEADER_SIZE + BMP_1BPP_PALETTE_SIZE + BMP_COPYRIGHT_SECTION_SIZE)

// Stałe BMP 4bpp
#define BMP_4BPP_PALETTE_SIZE 64
#define BMP_4BPP_DATA_OFFSET (BMP_HEADER_SIZE + BMP_INFO_HEADER_SIZE + BMP_4BPP_PALETTE_SIZE + BMP_COPYRIGHT_SECTION_SIZE)
