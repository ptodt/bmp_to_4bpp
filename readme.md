...
- **`scripts/update_version.sh`** - skrypt do aktualizacji `version.h` na podstawie `VERSION` (Linux/macOS)
- **`scripts/update_version.bat`** - skrypt do aktualizacji `version.h` na podstawie `VERSION` (Windows)
